...
namespace BLL.UrlFlow
{
    public class HomeUrlFlow : IHomeUrlFlow
    {
        ...
        public HomeUrlFlow()
        {
            ...
            CanUseAction.Add(Constans_Cinema.ACCOUNT_USERNAME, false);
                ...
                case MyStatusFlow.Registred:
                    {
                        ...
                        this.canUseAction[Constans_Cinema.ACCOUNT_USERNAME] = true;
                ...
                case MyStatusFlow.Not_Registred:
                    {
                        ...
                        this.canUseAction[Constans_Cinema.ACCOUNT_USERNAME] = false;
                        this.canUseAction[Constans_Cinema.ACCOUNT_LOGOUT] = true;
